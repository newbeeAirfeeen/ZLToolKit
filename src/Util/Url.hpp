...
protected:
  ...
  toolkit::string_view captureUpTo( const toolkit::string_view& right_delimiter, const std::string& error_message = "" );
  bool moveBefore( const toolkit::string_view& right_delimiter );
  bool existsForward( const toolkit::string_view& right_delimiter );
  ...
  toolkit::string_view parse_target;
